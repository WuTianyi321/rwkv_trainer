#!/usr/bin/env python3
"""
RWKV Training Script - Adapted for packaged use

This is a modified version of the original RWKV-LM train.py that works
with the rwkv_trainer package structure.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_type", default="", type=str)
    ...
    parser.add_argument("--my_pile_version", default=1, type=int)
...
############################################################################
#
# RWKV {args.precision.upper()} on {args.num_nodes}x{args.devices} {args.accelerator.upper()}, 
# bsz {args.num_nodes}x{args.devices}x{args.micro_bsz}={args.real_bsz}, {args.strategy}
#
# Data = {args.data_file} ({args.data_type}), ProjDir = {args.proj_dir}
#
# Epoch = {args.epoch_begin} to {args.epoch_begin + args.epoch_count - 1}
#
# Each epoch = {args.epoch_steps} steps, {samples_per_epoch} samples, {tokens_per_epoch} tokens
#
# Model = {args.n_layer} n_layer, {args.n_embd} n_embd, {args.ctx_len} ctx_len
#
# Adam = lr {args.lr_init} to {args.lr_final}, warmup {args.warmup_steps} steps
#
############################################################################
"""
    )
    ...
    if args.precision == "fp32":
        for i in range(10):
            rank_zero_info("\n\nNote: you are using fp32 (very slow).\n\n")
    if args.precision == "fp16":
        rank_zero_info("\n\nNote: you are using fp16 (might overflow).\n\n")
